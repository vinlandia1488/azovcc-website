          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                <span className="text-zinc-500 text-xs">UID: {user.unique_identifier ?? '—'}</span>
                {user.is_admin && (
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <InfoRow 
                ...
                value={user.internal_license} 
                icon={Fingerprint} 
                isSensitive={true} 
              />
              <InfoRow 
                label="Script License" 
                value={user.script_license} 
                icon={Key} 
                isSensitive={true} 
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5 p-3 rounded-xl bg-[#1a1a1e]/50 border border-zinc-800/50">
                <div className="flex items-center gap-2 text-zinc-500">
                  <div className="w-3.5 h-3.5 rounded-full" style={{ background: user.accent_color || accent }} />
