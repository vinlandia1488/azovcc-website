            ...
            {!selectedChatId ? (
              ...
              <>
                <div className="p-4 border-b border-zinc-800/60 bg-zinc-900/20 flex items-center justify-between">
                  ...
                  <button
                    onClick={() => {
                      setCustomKey(generateScriptLicense());
                  ...
                  >
                    <div className="relative flex-1">
                      <input
                        ...
                        className="w-full bg-zinc-900 border border-zinc-800 text-white rounded-xl pl-4 pr-10 py-2 text-sm focus:outline-none focus:border-indigo-500"
                      />
                      <label className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-zinc-500 hover:text-white transition">
                        <ImagePlus size={16} />
                        <input type="file" className="hidden" accept="image/*" onChange={handleAdminImageUpload} disabled={uploadingImage} />
                      </label>
                    </div>
                    <button
                      type="submit"
